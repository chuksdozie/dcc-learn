...
const HeroSection = ({
  ...
  return (
    <div className="relative flex flex-col items-center justify-end bg-gray-100 py-5 h-[400px] overflow-hidden  max-lg:h-[250px] bg-hero-bg bg-cover bg-center rounded-[30px] w-[90%]">
      ...
      <p className="text-6xl font-bold text-center w-[60%] mt-6 text-gray-100 max-lg:w-[90%] max-lg:text-2xl z-10 mb-10">
        {header || `Curated Learning for Your Tech Journey`}
      </p>
      <p className="text-sm font-light text-center w-[65%] text-gray-100 max-lg:w-[60%] max-md:w-[80%] z-10 max-lg:text-xs">
        {subHeader ||
      ...
      <div className=" flex w-full justify-center mt-2 md:hidden z-10">
